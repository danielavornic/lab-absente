...
return (
    ...
    <Stack spacing={4} mx={'auto'} maxW={'lg'} py={12} px={6} minW={'xl'}>
        ...
        <Stack spacing={4}>
            ...
            <Heading fontSize={'l'} alignSelf={'center'} color='brand.700'>Sistem Informaţional de Management Universitar</Heading>
            ...
            <FormLabel></FormLabel>
            <Input type="email" placeholder='Email corporativ' _placeholder={{ color: 'gray.600' }} color='gray.600'/>
            </FormControl>
            <Stack spacing={10}>
            <Button
                bg={'brand.600'}
